...
namespace kiyafet_otomasyon
{
    public partial class Form20 : Form
    {
        ...
        {
            SqlDataAdapter adtr = new SqlDataAdapter("select ad,soyad,tcKimlik,cepTel,evTel,adres,maas,kasaNo,gorevBaslangici,gorevBitimi,silinmeTarihi From silinmiskasiyerbil", frm1.bag);
            string alan = "";
            ...
            if (comboBox1.Text == "Tümü")
            {
                ...
                frm1.kmt.CommandText = "select ad,soyad,tcKimlik,cepTel,evTel,adres,maas,kasaNo,gorevBaslangici,gorevBitimi,silinmeTarihi From silinmiskasiyerbil";//tüm kayıtları seç
            ...
            {
                frm1.bag.Open();
                adtr.SelectCommand.CommandText = "select ad,soyad,tcKimlik,cepTel,evTel,adres,maas,kasaNo,gorevBaslangici,gorevBitimi,silinmeTarihi From silinmiskasiyerbil" + " where(" + alan + " like '%" + textBox1.Text + "%' )";
        ...
        private void sil_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cevap == DialogResult.Yes && dataGridView1.CurrentRow.Cells[0].Value.ToString().Trim() != "")
                {
                    frm1.bag.Open();
                    frm1.kmt.Connection = frm1.bag;
                    frm1.kmt.CommandText = "DELETE from silinmiskasiyerbil WHERE tcKimlik='" + dataGridView1.CurrentRow.Cells[2].Value.ToString() + "'";
                    frm1.kmt.ExecuteNonQuery();
                    frm1.kmt.Dispose();
                    frm1.bag.Close();
                    frm1.silinmiskasiyerListele();
                }
            }
            catch
            {
        ...
        private void Form20_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dataGridView1.Columns[10].HeaderText = "Silinme Tarihi";
            }
            catch
            {
                ;
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            frm1.frm12.dateTimePicker2.Text = dataGridView1.CurrentRow.Cells[10].Value.ToString();
